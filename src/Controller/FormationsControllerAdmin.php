...
class FormationsControllerAdmin extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pages/formation/new.html.twig', [
    ...
    public function edit(Formation $formation, Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pages/formation/edit.html.twig', [
            'formFormation' => $form->createView(),
            'formation' => $formation,
        ]);
    }
    ...
    public function delete(Formation $formation, Request $request, EntityManagerInterface $entityManager): Response
    {
